...
export default function ListReview() {
    ...
    return (
        <div className='salon-container mx-center section-wrap p-5rem'>
            <div className='list-review-container--header '>
                ...
                <div className='block-detail'>
                    ...
                    <div className='btn-salon'>
                        ...
                        <div className='btn-salon-container'>
                                ...
                                <button className="btn-list-review btn-w">
                                    Book Now
                                </button>
            ...
            <div className="list-review-container--content">
                <div className='list-review-wraper p-4'>
                    {/* COLUMN LEFT */}
                    <div className="customer-review ">
                        <div className="customer-review--rating">
                            <h2>Customer Reviews</h2>
                            <div className='review-rating'>
                                <img className='rating-star-booking' src="ratingStar.svg" alt="" />
                                <h3>4.5 Out of 5</h3>
                            </div>
                            <h3 className='review-rating__customer--count'>12345 Customer Rating</h3>
                            <img className='rating-chart-booking' src="ratingChart.svg" alt="" />
                        </div>
                        <div className="customer-review--location">
          ...
          />
                    ...
                    <div className="review-container ">
                        <div className="review-image">
                            ...
                            <div className="review-image-show">
                                <img src="reviewImage.svg" alt="" />
                                <img src="reviewImage.svg" alt="" />
                                <img src="reviewImage.svg" alt="" />
                                <img src="reviewImage.svg" alt="" />
                            </div>
                            <h3>View all the image</h3>
                        </div>
                        <div className="top-review">
                            <div className="top-review__header">
                                <h2>Top Reviews</h2>
                                <div className="top-review__button">
                                    <input type="search" placeholder='Search by keyword' />
                                    <button className='btn-sort'>Sort by: All</button>
                                    <button className='btn-filter'>Filter by rating</button>
                                </div>
                            </div>
                        {
                            topReview.map((item, index) => (
                                <div key={index} className='review-item-container flex-col'>
